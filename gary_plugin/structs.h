...
public:
	...
	static GameInterfaceManager *	GetSingleton(void);
	static bool					IsMenuVisible(UInt32 menuType);
	static void *				GetMenuByType(UInt32 menuType);
	static void *				TempMenuByType(UInt32 menuType);
